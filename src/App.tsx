  ...
  <div className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-black/40 border-b border-white/10">
    <div className="container-locked flex items-center justify-between px-4 py-3">
      <a href="#" className="flex items-center gap-2">
        ...
        <span className="font-bold">The Ecombinators</span>
      </a>
    ...
    <div className="relative container-locked px-4 py-20 md:py-28">
      <motion.div {...fadeIn(0)} className="max-w-3xl">
        <h1 className="text-4xl md:text-6xl font-extrabold leading-tight">
          <span className="animated-gradient gradient-text">We Build Scalable AI-Powered Applications</span>
        </h1>
        <p className="mt-4 text-lg md:text-xl text-white/80 max-w-2xl">
          From MVP to enterprise-grade AI systems, delivered 40% faster.
        </p>
...
// SERVICES
const services = [
  { icon: <Rocket />, title: 'Full-Stack Development', desc: 'Web & mobile apps built with modern stacks, from prototypes to production.' },
  { icon: <Bot />, title: 'GenAI & LLM Integrations', desc: 'LLM-powered features, prompt pipelines, embeddings, and tuning.' },
  { icon: <Database />, title: 'RAG-powered Knowledge Systems', desc: 'Retrieval-Augmented Generation for private, up-to-date knowledge.' },
  { icon: <Cog />, title: 'AI Agents & Automation', desc: 'Task-oriented agents and workflow automation for real business impact.' },
]
...
const WhyUs = () => (
  <section id="why" className="container-locked px-4 py-16 md:py-24">
    <SectionTitle kicker="Why Us" title="Why Choose The Ecombinators" />
    <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
      {why.map((w, i) => (
...
// TESTIMONIALS
const testimonials = [
  { name: 'Alex Carter', role: 'CTO, FinCore', text: 'The Ecombinators delivered our RAG platform in record time. Fantastic partnership.', avatar: 'https://i.pravatar.cc/100?img=1' },
  { name: 'Priya Singh', role: 'Head of Ops, Helio', text: 'Their agents automated half our triage workload. Solid engineering and UX.', avatar: 'https://i.pravatar.cc/100?img=5' },
  { name: 'Liam Chen', role: 'VP Product, Omnia', text: 'They shipped an AI copilot that our sales team loves. Results showed up fast.', avatar: 'https://i.pravatar.cc/100?img=12' },
]
      ...
      <div className="card rounded-2xl p-8 md:p-10 ring-1 ring-white/10 hover:ring-accent/40 transition-all">
        <div className="md:flex md:items-start md:justify-between gap-8">
          <div className="md:w-1/2">
            <h3 className="text-2xl md:text-3xl font-extrabold">Let’s build your next AI-powered product.</h3>
            <p className="mt-2 text-white/70 text-sm">Tell us about your project and we’ll get back within 24 hours.</p>
            <div className="mt-6 space-y-2 text-sm">
              <p className="flex items-center gap-2"><Mail size={16} className="text-accent"/> contact@ecombinators.com</p>
              <p className="flex items-center gap-2"><Phone size={16} className="text-accent"/> +917075240989</p>
            </div>
            <div className="mt-6">
...
const Footer = () => (
  <footer className="py-10 border-t border-white/10">
    <div className="container-locked px-4 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-white/60">
      <p>© {new Date().getFullYear()} The Ecombinators. All rights reserved.</p>
